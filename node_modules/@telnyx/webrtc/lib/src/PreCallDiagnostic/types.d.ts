...
export declare type PreCallDiagnosticWarning = PreCallDiagnosticReason;
...
export declare type MicrophonePermissionState = 'granted' | 'denied' | 'prompt' | 'unknown';
...
export interface PreCallDiagnosticReport {
    version: 1;
    verdict?: 'ready' | 'degraded' | 'blocked' | 'permission_denied' | 'inconclusive';
    reasons?: PreCallDiagnosticReason[];
